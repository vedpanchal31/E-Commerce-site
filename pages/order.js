      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            ...
            <p className="leading-relaxed mb-4">Yay ! Your Order has been placed Successfully! </p>
            <p className="leading-relaxed mb-4">Order Placed On: {date && date.toLocalDateString("en-IN")}</p>
            <p>
             Your payment status is <span className='font-semibold text-slate-700-700'>{order.status}</span>
            </p>
            ...
            <div className="flex flex-col">
              <span className="title-font font-medium text-2xl text-gray-900 my-8">Subtotal : ₹{order.amount}</span>
              <div className='my-6'>
          ...
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="order.webp" />
        </div>
      </div>
    </section>
  )
